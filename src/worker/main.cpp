...
void run_worker(const std::string &broker, const std::string &worker_pub_bind, const std::string &worker_pull_port, const std::string &connect_to_worker, const std::string &database_path, bool verbose) {
